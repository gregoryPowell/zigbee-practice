...
sli_zigbee_af_form_and_join_energy_scan_result_callback(channel, maxRssiValue);
}
...
sli_zigbee_af_form_and_join_network_found_callback(networkFound, lqi, rssi);
}
...
sli_zigbee_af_form_and_join_scan_complete_callback(channel, status);
}
...
sli_zigbee_af_form_and_join_unused_pan_id_found_callback(panId, channel);
