...
static const sl_cli_command_info_t cli_cmd_find_mask = \
  SL_CLI_COMMAND(findMaskCommand,
                 "Sets a channel mask for a given channel page for find joinable and find unused.",
...
static const sl_cli_command_info_t cli_cmd_find_mode = \
  SL_CLI_COMMAND(findModeCommand,
                 "Sets a search mode for find joinable and find unused.",
...
static const sl_cli_command_info_t cli_cmd_find_print = \
  SL_CLI_COMMAND(findPrintCommand,
                 "Prints network search parameters (mode and channel masks).",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_price_hyphen_common_adj_hyphen_st_hyphen_t = \
  SL_CLI_COMMAND(sli_zigbee_af_price_common_cluster_get_adjusted_start_time_cli,
...
static const sl_cli_command_info_t cli_cmd_price_hyphen_common_cnvrt_hyphen_durn_hyphen_to_hyphen_sec = \
  SL_CLI_COMMAND(sli_zigbee_af_price_common_cluster_convert_duration_to_seconds_cli,
                 "Converts the duration to a number of seconds based on the duration type parameter.",
                  "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT32, SL_CLI_ARG_UINT32, SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });
...
static const sl_cli_command_info_t cli_cmd_custom_get_hyphen_led = \
  SL_CLI_COMMAND(getLedCommand,
                 "Get the state of an LED on the NCP.",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_custom_set_hyphen_led = \
  SL_CLI_COMMAND(setLedCommand,
                 "Set the state of an LED on the NCP using a custom LED protocol command.",
                  "" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_custom_get_hyphen_frequency = \
  SL_CLI_COMMAND(getFrequencyCommand,
                 "Get the current frequency of the LED strobe on the NCP.",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_custom_set_hyphen_frequency = \
  SL_CLI_COMMAND(setFrequencyCommand,
                 "Set the frequency of the LED strobe on the NCP.",
                  "" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT32, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_custom_get_hyphen_info = \
...
static const sl_cli_command_entry_t price_hyphen_common_group_table[] = {
  { "adj-st-t", &cli_cmd_price_hyphen_common_adj_hyphen_st_hyphen_t, false },
  { "cnvrt-durn-to-sec", &cli_cmd_price_hyphen_common_cnvrt_hyphen_durn_hyphen_to_hyphen_sec, false },
  { NULL, NULL, false },
};
static const sl_cli_command_info_t cli_cmd_grp_price_hyphen_common = \
  SL_CLI_COMMAND_GROUP(price_hyphen_common_group_table, "price-common related commands.");
...
static const sl_cli_command_entry_t plugin_group_table[] = {
  ...
  { "price-common", &cli_cmd_grp_price_hyphen_common, false },
  { NULL, NULL, false },
};
...
static const sl_cli_command_entry_t custom_group_table[] = {
  { "get-led", &cli_cmd_custom_get_hyphen_led, false },
  { "set-led", &cli_cmd_custom_set_hyphen_led, false },
  { "get-frequency", &cli_cmd_custom_get_hyphen_frequency, false },
  { "set-frequency", &cli_cmd_custom_set_hyphen_frequency, false },
  { "get-info", &cli_cmd_custom_get_hyphen_info, false },
  { NULL, NULL, false },
};
static const sl_cli_command_info_t cli_cmd_grp_custom = \
  SL_CLI_COMMAND_GROUP(custom_group_table, "");
